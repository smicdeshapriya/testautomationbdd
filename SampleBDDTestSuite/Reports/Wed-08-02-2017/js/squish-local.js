...
function dataErrorMessage() {
    ...
    errorMsgBox.append("This report does not contain data file data/results-v1.js with test results or this file is corrupted. Please ensure that Web Report was generated proper way using squishrunner with html report generator option. If problem still persists please contact Squish Support (squish@froglogic.com) and attach the zipped report directory.");
